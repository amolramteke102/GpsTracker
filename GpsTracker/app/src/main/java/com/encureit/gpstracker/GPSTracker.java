...
public class GPSTracker extends Service implements LocationListener {
    ...
    public GPSTracker(Context context, boolean saveLocation) {
    ...
    @SuppressLint("NewApi")
    public Location getLocation(boolean saveLocation) {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isNetworkEnabled) {
                    ...
                    if (locationManager != null) {
                        ...
                        Log.e("Net_Location", String.valueOf(location));
                        if (location != null) {
                ...
                if (isGPSEnabled) {
                    if (location == null || location.getAccuracy() <= 20) {
                        ...
                        if (locationManager != null) {
                            ...
                            Log.e("GPS_Location", String.valueOf(location));
                            if (location != null) {
                                latitude = location.getLatitude();
                                longitude = location.getLongitude();
                                /*Configuration cf = Configuration.getInstance(Utils.getContext());
                                LatLng new_location = new LatLng(latitude, longitude);
                                if (saveLocation)
                                    cf.setLocation(new_location);*/
                            }
                        }
                    }
                }
